...
<section id="container">
  ...
  <ul class="menu">
      ...
      <li><a href="panier.php" class="link">Panier</a></li>
        ...
        <table>
            ...
            <?php 
              ...
              if(empty($ids)){
                ...
                //si oui 
                $products = mysqli_query($con, "SELECT * FROM skin WHERE id IN (".implode(',', $ids).")");
                ...
                ?>
                <tr>
                    <td><img src="pictures/<?=$product['img']?>"></td>
                    <td><?=$product['name']?></td>
                    <td><?=$product['price']?>DH</td>
                    <td><?=$_SESSION['panier'][$product['id']] // Quantité?></td>
                    <td><a href="panier.php?del=<?=$product['id']?>"><img src="pictures/DELETE.jpg"></a></td>
                </tr>
